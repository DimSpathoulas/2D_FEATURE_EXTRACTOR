...
def main():
    ...
    parser.add_argument('--detection_file', type=str,
                        default="/home/ktsiakas/thesis_new/PC_FEATURE_EXTRACTOR/tools/train_conv_layer51233_thr020_050_interpolated.npy",
                        help='Path to the npy detection file')
    parser.add_argument('--output_file', type=str,
                        default='train_conv_layer51233_thr020_050_interpolated.pkl',
